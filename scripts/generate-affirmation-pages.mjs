...
function head({title, description, canonical, image, prefix = "../", detail = false, schema}) {
  return `<head>
    ...
    <link rel="stylesheet" href="${prefix}css/main.css?v=ea58efc3" /><link rel="stylesheet" href="${prefix}css/affirmations.css?v=11" />${detail ? `<link rel="stylesheet" href="${prefix}css/affirmation-detail.css?v=5" />` : ""}
